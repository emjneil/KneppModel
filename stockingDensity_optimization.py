...
def objectiveFunction(x):
    ...
    # stocking_roeDeer = x[4]
    stocking_tamworthPig = x[4]


    # define growth 
    r_9 = [0, 0, 0.97, 0, 0, 0, 0, 0, 0.77, 0.061] 
    # define interaction strength
    A_9 = [
                # exmoor pony - special case, no growth
                [-0.001, 0, 0, 0, 0, 0, 0, 0, 0, 0],
                # fallow deer 
                [0, -15.9, 85.5, 0, 0, 0, 0, 0, 0.48, 41.3],
                # grassland parkland
                [-0.00069, -0.0004, -0.78, -0.0008, -0.00049, 0, -0.00029, -0.0034, -0.01, -0.14],
                # longhorn cattle  
                [0, 0, 19.4, -14.97, 0, 0, 0, 0, 0.15, 12.4],
                # organic carbon
                [0.0075, 0.0048, 0.044, 0.0065, -0.083, 0.0053, 0.0041, 0.005, 0.0011, 0.044],  
                # red deer  
                [0, 0, 15.6, 0, 0, -15.1, 0, 0, 0.82, 13.4],
                # roe deer 
                [0, 0, 11.9, 0, 0, 0, -14.5, 0, 0.56, 11.3],
                # tamworth pig 
                [0, 0, 3.91, 0, 0, 0, 0, -14.3, 0.35, 3],  
                # thorny scrub
                [-0.038, -0.02, 0, -0.042, 0, -0.031, -0.012, -0.013, -0.0072, -0.13],
                # woodland
                [-0.0046, -0.0021, 0, -0.0058, 0, -0.0051, -0.0014, -0.0019, 0.00035, -0.009]
    ]
    ...
    # define X0 in 2021
    X0 = [(0.65*stocking_exmoorPony), (5.88*stocking_fallowDeer), 0.66, (1.53*stocking_longhornCattle), 2.14, (2.69*stocking_redDeer), 2.56, (0.95*stocking_tamworthPig), 25.18, 1.35]
    ...
    # stocking_values_2022[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2023[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2024[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2025[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2026[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2027[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2028[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2029[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2030[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2031[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2032[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2033[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2034[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2035[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2036[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2037[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2038[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2039[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2040[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2041[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2042[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2043[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2044[6] =  4.13*stocking_roeDeer
    ...
    # stocking_values_2045[6] =  4.13*stocking_roeDeer
    ...
    #       grassland loss: < 10% (normalized to 0.13) 2
    ...
    result = ((last_year_finaldf[2]-0.13)**2)
...
# bds =  ((0.02,10),(0.02,10),(0.06,10),(0.09,10),(0.2,10)) 
