...
def generateParameters2():
    ...
    for X0_nocull, r_nocull, A_nocull in zip(X0_secondRun,r_secondRun, np.array_split(A_secondRun,len(accepted_simulations))):
        # run the model for one year 2009-2010 (to account for herbivore numbers being manually controlled every year)
        noReintro_ABC = solve_ivp(ecoNetwork, (4, 39), X0_nocull,  t_eval = t_2, args=(A_nocull, r_nocull), method = 'RK23') 
    ...
    for X0_3, r_2, A_2 in zip(X0_secondRun,r_secondRun, np.array_split(A_secondRun,len(accepted_simulations))):
        ...
        starting_values_2010[1] = 2.0*0.25
        starting_values_2010[4] = 0.5*0.25
        ...
        starting_values_2011[1] = 1.1*0.25
        starting_values_2011[4] = 1.3*0.25
        ...
        starting_values_2012[1] = 1.1*0.25
        starting_values_2012[4] = 1.5*0.25
        ...
        starting_values_2013[1] = 1.8*0.25
        starting_values_2013[4] = 0.18*0.25
        ...
        starting_values_2014[1] = 0.6*0.25
        starting_values_2014[4] = 3*0.25
        ...
        starting_values_2015[1] = 1.2*0.25
        starting_values_2015[4] = 0.5*0.25
        ...
        starting_values_2016[1] = 1.21*0.25
        starting_values_2016[4] = 0.5*0.25
        ...
        starting_values_2017[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_values_2017[4] = np.random.uniform(low=0.18,high=3)*0.25
        ...
        starting_values_2018[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_values_2018[4] = np.random.uniform(low=0.18,high=3)*0.25
        ...
        starting_values_2019 = tenth_ABC.y[0:7, 1:2]
        starting_values_2019 = starting_values_2019.flatten()
        starting_values_2019[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_values_2019[4] = np.random.uniform(low=0.18,high=3)*0.25
        ...
        ABC_12 = solve_ivp(ecoNetwork, (14, 15), starting_values_2019,  t_eval = t, args=(A_2, r_2), method = 'RK23')        
        # take those values and re-run for another year, adding forcings
        starting_2020 = ABC_12.y[0:7, 1:2]
        starting_2020 = starting_2020.flatten()
        starting_2020[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2020[4] =  np.random.uniform(low=0.18,high=3)*0.25
        t_1 = np.linspace(15, 16, 2)
        # run the model for another year 2020
        ABC_13 = solve_ivp(ecoNetwork, (15, 16), starting_2020,  t_eval = t_1, args=(A_2, r_2), method = 'RK23')
        # take those values and re-run for another year, adding forcings
        starting_next = ABC_13.y[0:9, 1:2]
        starting_next = starting_next.flatten()
        starting_next[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_next[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_2 = np.linspace(16, 17, 2)
        # run the model for 2021
        ABC_14 = solve_ivp(ecoNetwork, (16, 17), starting_next,  t_eval = t_2, args=(A_2, r_2), method = 'RK23')
        # take those values and re-run for another year, adding forcings
        starting_2021 = ABC_14.y[0:9, 1:2]
        starting_2021 = starting_2021.flatten()
        starting_2021[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2021[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_3 = np.linspace(17, 18, 2)
        # run the model for 2022
        ABC_15 = solve_ivp(ecoNetwork, (17, 18), starting_2021,  t_eval = t_3, args=(A_2, r_2), method = 'RK23')
        # take those values and re-run for another year, adding forcings
        starting_2022 = ABC_15.y[0:9, 1:2]
        starting_2022 = starting_2022.flatten()
        starting_2022[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2022[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_4 = np.linspace(18, 19, 2)
        # run the model for 2023
        ABC_16 = solve_ivp(ecoNetwork, (18, 19), starting_2022,  t_eval = t_4, args=(A_2, r_2), method = 'RK23')
        # take those values and re-run for another year, adding forcings
        starting_2023 = ABC_16.y[0:9, 1:2]
        starting_2023 = starting_2023.flatten()
        starting_2023[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2023[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_5 = np.linspace(19, 20, 2)
        # run the model for 2024
        ABC_17 = solve_ivp(ecoNetwork, (19, 20), starting_2023,  t_eval = t_5, args=(A_2, r_2), method = 'RK23')
        # take those values and re-run for another year, adding forcings
        starting_2024 = ABC_17.y[0:9, 1:2]
        starting_2024 = starting_2024.flatten()
        starting_2024[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2024[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_6 = np.linspace(20, 21, 2)
        # run the model for 2011-2012
        ABC_18 = solve_ivp(ecoNetwork, (20, 21), starting_2024,  t_eval = t_6, args=(A_2, r_2), method = 'RK23')
        # take those values and re-run for another year, adding forcings
        starting_2025 = ABC_18.y[0:9, 1:2]
        starting_2025 = starting_2025.flatten()
        starting_2025[1] =np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2025[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_7 = np.linspace(21, 22, 2)
        # run the model for 2011-2012
        ABC_19 = solve_ivp(ecoNetwork, (21,22), starting_2025,  t_eval = t_7, args=(A_2, r_2), method = 'RK23')
        # take those values and re-run for another year, adding forcings
        starting_2026 = ABC_19.y[0:9, 1:2]
        starting_2026 = starting_2026.flatten()
        starting_2026[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2026[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_8 = np.linspace(22, 23, 2)
        # run the model for 2011-2012
        ABC_20 = solve_ivp(ecoNetwork, (22, 23), starting_2026,  t_eval = t_8, args=(A_2, r_2), method = 'RK23')
        # take those values and re-run for another year, adding forcings
        starting_2027 = ABC_20.y[0:9, 1:2]
        starting_2027 = starting_2027.flatten()
        starting_2027[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2027[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_9 = np.linspace(23, 24, 2)
        # run the model to 2028
        ABC_21 = solve_ivp(ecoNetwork, (23, 24), starting_2027,  t_eval = t_9, args=(A_2, r_2), method = 'RK23')
        # just to check longer (up to 25 yrs)
        starting_2028 = ABC_21.y[0:9,1:2]
        starting_2028 = starting_2028.flatten()
        starting_2028[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2028[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_10 = np.linspace(24, 25, 2)
        # 2029
        ABC_22 = solve_ivp(ecoNetwork, (24, 25), starting_2028,  t_eval = t_10, args=(A_2, r_2), method = 'RK23')
        starting_2029 = ABC_22.y[0:9, 1:2]
        starting_2029 = starting_2029.flatten()
        starting_2029[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2029[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_11 = np.linspace(25, 26, 2)
        # 2030
        ABC_23 = solve_ivp(ecoNetwork, (25, 26), starting_2029,  t_eval = t_11, args=(A_2, r_2), method = 'RK23')
        starting_2030 = ABC_23.y[0:9, 1:2]
        starting_2030 = starting_2030.flatten()
        starting_2030[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2030[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_12 = np.linspace(26, 27, 2)
        # 2031
        ABC_24 = solve_ivp(ecoNetwork, (26, 27), starting_2030,  t_eval = t_12, args=(A_2, r_2), method = 'RK23')
        starting_2031 = ABC_24.y[0:9, 1:2]
        starting_2031 = starting_2031.flatten()
        starting_2031[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2031[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_13 = np.linspace(27, 28, 2)
        # 2032
        ABC_25 = solve_ivp(ecoNetwork, (27, 28), starting_2031,  t_eval = t_13, args=(A_2, r_2), method = 'RK23')
        starting_2032 = ABC_25.y[0:9, 1:2]
        starting_2032 = starting_2032.flatten()
        starting_2032[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2032[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_14 = np.linspace(28, 29, 2)
        # 2033
        ABC_26 = solve_ivp(ecoNetwork, (28, 29), starting_2032,  t_eval = t_14, args=(A_2, r_2), method = 'RK23')
        starting_2033 = ABC_26.y[0:9, 1:2]
        starting_2033 = starting_2033.flatten()
        starting_2033[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2033[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_15 = np.linspace(29, 30, 2)
        # 2034
        ABC_27 = solve_ivp(ecoNetwork, (29, 30), starting_2033,  t_eval = t_15, args=(A_2, r_2), method = 'RK23')
        starting_2034 = ABC_27.y[0:9, 1:2]
        starting_2034 = starting_2034.flatten()
        starting_2034[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2034[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_16 = np.linspace(30, 31, 2)
        # 2035
        ABC_28 = solve_ivp(ecoNetwork, (30, 31), starting_2034,  t_eval = t_16, args=(A_2, r_2), method = 'RK23')
        starting_2035 = ABC_28.y[0:9, 1:2]
        starting_2035 = starting_2035.flatten()
        starting_2035[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2035[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_17 = np.linspace(31, 32, 2)
        # 2036
        ABC_29 = solve_ivp(ecoNetwork, (31, 32), starting_2035,  t_eval = t_17, args=(A_2, r_2), method = 'RK23')
        starting_2036 = ABC_29.y[0:9, 1:2]
        starting_2036 = starting_2036.flatten()
        starting_2036[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2036[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_18 = np.linspace(32, 33, 2)
        # 2037
        ABC_30 = solve_ivp(ecoNetwork, (32, 33), starting_2036,  t_eval = t_18, args=(A_2, r_2), method = 'RK23')
        starting_2037 = ABC_30.y[0:9, 1:2]
        starting_2037 = starting_2037.flatten()
        starting_2037[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2037[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_19 = np.linspace(33, 34, 2)
        # 2038
        ABC_31 = solve_ivp(ecoNetwork, (33, 34), starting_2037,  t_eval = t_19, args=(A_2, r_2), method = 'RK23')
        starting_2038 = ABC_31.y[0:9, 1:2]
        starting_2038 = starting_2038.flatten()
        starting_2038[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2038[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_20 = np.linspace(34, 35, 2)
        # 2039
        ABC_32 = solve_ivp(ecoNetwork, (34, 35), starting_2038,  t_eval = t_20, args=(A_2, r_2), method = 'RK23')
        starting_2039 = ABC_32.y[0:9, 1:2]
        starting_2039 = starting_2039.flatten()
        starting_2039[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2039[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_21 = np.linspace(35, 36, 2)
        # 2040
        ABC_33 = solve_ivp(ecoNetwork, (35, 36), starting_2039,  t_eval = t_21, args=(A_2, r_2), method = 'RK23')
        starting_2040 = ABC_33.y[0:9, 1:2]
        starting_2040 = starting_2040.flatten()
        starting_2040[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2040[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_22 = np.linspace(36, 37, 2)
        # 2041
        ABC_34 = solve_ivp(ecoNetwork, (36, 37), starting_2040,  t_eval = t_22, args=(A_2, r_2), method = 'RK23')
        starting_2041 = ABC_34.y[0:9, 1:2]
        starting_2041 = starting_2041.flatten()
        starting_2041[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2041[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_23 = np.linspace(37, 38, 2)
        # 2042
        ABC_35 = solve_ivp(ecoNetwork, (37, 38), starting_2041,  t_eval = t_23, args=(A_2, r_2), method = 'RK23')
        starting_2042 = ABC_35.y[0:9, 1:2]
        starting_2042 = starting_2042.flatten()
        starting_2042[1] = np.random.uniform(low=0.56,high=2.0)*0.25
        starting_2042[4] = np.random.uniform(low=0.18,high=3)*0.25
        t_24 = np.linspace(38, 39, 2)
        # 2043
        ABC_36 = solve_ivp(ecoNetwork, (38, 39), starting_2042,  t_eval = t_24, args=(A_2, r_2), method = 'RK23')
        # concatenate & append all the runs
        combined_runs_halfCull = np.hstack((second_ABC.y,third_ABC.y, fourth_ABC.y, fifth_ABC.y, sixth_ABC.y, seventh_ABC.y, eighth_ABC.y, ninth_ABC.y, tenth_ABC.y, eleventh_ABC.y, ABC_12.y, ABC_13.y,ABC_14.y,ABC_15.y,ABC_16.y,ABC_17.y,ABC_18.y,ABC_19.y,ABC_20.y,ABC_21.y,ABC_22.y,ABC_23.y,ABC_24.y,ABC_25.y,ABC_26.y,ABC_27.y,ABC_28.y,ABC_29.y,ABC_30.y,ABC_31.y,ABC_32.y,ABC_33.y,ABC_34.y,ABC_35.y,ABC_36.y))
        combined_times_halfCull = np.hstack((second_ABC.t, third_ABC.t, fourth_ABC.t, fifth_ABC.t, sixth_ABC.t, seventh_ABC.t, eighth_ABC.t, ninth_ABC.t, tenth_ABC.t, eleventh_ABC.t, ABC_12.t, ABC_13.t,ABC_14.t,ABC_15.t,ABC_16.t,ABC_17.t,ABC_18.t,ABC_19.t,ABC_20.t,ABC_21.t,ABC_22.t,ABC_23.t,ABC_24.t,ABC_25.t,ABC_26.t,ABC_27.t,ABC_28.t,ABC_29.t,ABC_30.t,ABC_31.t,ABC_32.t,ABC_33.t,ABC_34.t,ABC_35.t,ABC_36.t))
        all_runs_half = np.append(all_runs_half, combined_runs_halfCull)
        all_times_half = np.append(all_times_half, combined_times_halfCull)
    half_cull = (np.vstack(np.hsplit(all_runs_half.reshape(len(species)*len(accepted_simulations), 70).transpose(),len(accepted_simulations))))
    half_cull = pd.DataFrame(data=half_cull, columns=species)
    half_cull['time'] = all_times_half
    half_cull = pd.concat([half_cull, filtered_FinalRuns])
    half_cull['accepted?'] = "halfCulls"
    return r_secondRun, X0_secondRun, A_secondRun, accepted_simulations, final_runs, NUMBER_OF_SIMULATIONS, no_reintro, half_cull
...
def runODE_2():
    r_secondRun, X0_secondRun, A_secondRun, accepted_simulations, final_runs, NUMBER_OF_SIMULATIONS, no_reintro, half_cull  = generateParameters2()
    ...
    return final_runs_2, all_parameters_2, accepted_simulations, final_runs, NUMBER_OF_SIMULATIONS, no_reintro, half_cull
...
def filterRuns_2():
    final_runs_2, all_parameters_2, accepted_simulations, final_runs, NUMBER_OF_SIMULATIONS, no_reintro, half_cull= runODE_2()
    ...
    return accepted_simulations_2018, accepted_parameters_2018, final_runs_2, accepted_simulations, final_runs, NUMBER_OF_SIMULATIONS, no_reintro, half_cull
...
def generateParameters3():
    accepted_simulations_2018, accepted_parameters_2018, final_runs_2, accepted_simulations, final_runs, NUMBER_OF_SIMULATIONS, no_reintro, half_cull = filterRuns_2()
    # # select growth rates 
    ...
    return r_thirdRun, X0_thirdRun, A_thirdRun, accepted_simulations_2018, final_runs_2, accepted_simulations, final_runs, NUMBER_OF_SIMULATIONS, no_reintro, half_cull
...
def runODE_3():
    r_thirdRun, X0_thirdRun, A_thirdRun, accepted_simulations_2018, final_runs_2, accepted_simulations, final_runs, NUMBER_OF_SIMULATIONS, no_reintro, half_cull  = generateParameters3()
    all_runs_3 = []
    all_parameters_3 = []
    all_times_3 = []
    t = np.linspace(14, 15, 2)
    ...
    return final_runs_3, accepted_simulations_2018, final_runs_2, accepted_simulations, final_runs, NUMBER_OF_SIMULATIONS, no_reintro, half_cull
...
def plotting():
    final_runs_3, accepted_simulations_2018, final_runs_2, accepted_simulations, final_runs, NUMBER_OF_SIMULATIONS, no_reintro, half_cull = runODE_3()
    ...
    accepted_shape5 = np.repeat(half_cull['accepted?'], len(species))
    # concatenate them
    ...
    grouping5 = np.repeat(half_cull['ID'], len(species))
    # concantenate them 
    ...
    y_halfcull = half_cull.drop(['ID', 'accepted?','time'], axis=1).values.flatten()
    # concatenate them
    y_values = np.concatenate((final_runs1, final_runs2, final_runs3, y_noReintro, y_halfcull), axis=0)
    ...
    species_halfCull = np.tile(species, (8*len(accepted_simulations) + 70*len(accepted_simulations)))
    species_list = np.concatenate((species_firstRun, species_secondRun, species_thirdRun, species_noReintro,species_halfCull), axis=0)
    # time 
    ...
    indices_halfCull = np.repeat(half_cull['time'],len(species))
    indices = pd.concat([firstODEyears, secondODEyears, thirdODEyears, indices_noReintro, indices_halfCull], axis=0)
    ...
    filtered_df = final_df.loc[(final_df['runType'] == "Accepted") | (final_df['runType'] == "noCulls") | (final_df['runType'] == "halfCulls")]
    # Create an array with the colors you want to use
    colors = ["#6788ee", "#e26952", '#f7a889']
    ...
    for ax in g.axes.flat:
        ...
        ax.fill_between(ax.lines[5].get_xdata(),ax.lines[5].get_ydata(), ax.lines[8].get_ydata(), color = '#f7a889', alpha=0.2)
    ...
    plt.tight_layout()
    plt.legend(labels=['Current Culling','No Culling', 'Culling 75% More'],bbox_to_anchor=(2, 0), loc='lower right', fontsize=12)
