...
def runODE_1():
    ...
    print("number of stable simulations", NUMBER_OF_SIMULATIONS)
    
    with open("ps1_stable_numberStable.txt", "w") as text_file:
        print("number of stable simulations: {}".format(NUMBER_OF_SIMULATIONS), file=text_file)
